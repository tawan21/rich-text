...
function Header() {
    return (
        <header className="sticky top-0 z-50 flex items-center p-3 shadow-md bg-white">
            ...
            <Icon className="text-blue-600 text-5xl">description</Icon>
            <h1 className="ml-2 text-gray-700 text-2xl">Docs</h1>
            <div className="mx-5 md:mx-20 flex flex-grow items-center p-3 bg-gray-200 text-gray-600 rounded focus-within:shadow focus-within:text-gray-700">
